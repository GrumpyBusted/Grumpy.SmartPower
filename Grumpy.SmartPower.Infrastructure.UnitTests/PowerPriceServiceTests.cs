...
namespace Grumpy.SmartPower.Infrastructure.UnitTests
{
    public class PowerPriceServiceTests
    {
        ...
        public void IsBatteryFullWith100ShouldBeTrue()
        {
            ...
            client.GetPrices(Arg.Is(PriceArea.DK2), Arg.Is(DateTime.Parse("2022-02-01T00:00:00")), Arg.Is(DateTime.Parse("2022-02-01T23:59:59"))).Returns(x => new List<PowerPrice.Client.EnergyDataService.Dtos.PowerPrice>() { new PowerPrice.Client.EnergyDataService.Dtos.PowerPrice() });
