...
namespace Grumpy.SmartPower.Infrastructure.UnitTests
{
    ...
    public class HouseBatteryServiceTests
    {
        ...
        public void SetModeToStoreShouldSetToTimeOfUseWithZeroFromGrid()
        {
            ...
            client.Received(1).SetSchedule(Arg.Is<IEnumerable<TimeOfUseEvent>>(x => x.Any(i => i.Watt == 0) && x.Count() == 1));
        }
        ...
        public void SetModeToStoreShouldSetScheduleToHour()
        {
            ...
            client.Received(1).SetSchedule(Arg.Is<IEnumerable<TimeOfUseEvent>>(x => x.Any(i => i.Start == "12:00" & i.End == "13:00") && x.Count() == 1));
        }
