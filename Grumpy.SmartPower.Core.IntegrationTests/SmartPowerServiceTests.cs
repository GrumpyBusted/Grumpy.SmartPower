...
namespace Grumpy.SmartPower.Core.IntegrationTests
{
    public class SmartPowerServiceTests
    {
        ...
        private ISmartPowerService CreateTestObject()
        {
            ...
            var houseBarreyService = new HouseBatteryService(sonnenBatteryClient);
            ...
            return new SmartPowerService(Options.Create(_smartPowerServiceOptions), powerPriceService, houseBarreyService, productionService, consumptionService, realTimeReadingRepository);
        }
    }
}